...
var url='index.php?module=Emails&action=ComposeView&in_popup=1&targetModule='+targetModule+ids+'&relatedModule='+currentModule+'&relatedId='+relatedId;if(document.MassUpdate.select_entire_list.value==1){url+='&current_post='+document.MassUpdate.current_query_by_page.value;}
...
recipientName=$(this).attr('data-record-name');if(dataEmailName!==''){recipientName=dataEmailName;}
