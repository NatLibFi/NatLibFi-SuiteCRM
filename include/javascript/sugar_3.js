...
var isAjaxCall=document.createElement('input');isAjaxCall.name='ajaxCall';isAjaxCall.type='hidden';isAjaxCall.value=true;newForm.appendChild(isAjaxCall);var isListView=document.createElement('input');isListView.name='ListView';isListView.type='hidden';isListView.value=true;newForm.appendChild(isListView);var toPdf=document.createElement('input');toPdf.name='to_pdf';toPdf.type='hidden';toPdf.value=true;newForm.appendChild(toPdf);if(document.MassUpdate.select_entire_list.value==1){var postTa=document.createElement('textarea');postTa.name='current_post';postTa.value=document.MassUpdate.current_query_by_page.value;postTa.style.display='none';newForm.appendChild(postTa);}
...
var emailComposeUrl='index.php?module=Emails&action=Compose&ListView=true&uid='+uidTa.value+'&action_module='+action_module;var emailLink=document.createElement('a');emailLink.target='_blank';emailLink.href=emailComposeUrl;document.body.appendChild(emailLink);emailLink.click();emailLink.parentNode.removeChild(emailLink);document.MassUpdate.uid.value='';return false;}
