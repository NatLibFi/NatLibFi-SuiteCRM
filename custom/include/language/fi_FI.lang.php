...
$GLOBALS['app_list_strings']['hallinnonala_list']=array (
  ...
  'muu_hallinnonala' => 'Muu hallinnonala',
);
$GLOBALS['app_list_strings']['alliance_coordinator_list']=array (
  'unknown' => 'ei tiedossa',
  'member1' => 'Jäsenorganisaatio 1',
  'member2' => 'Jäsenorganisaatio 2',
);
$GLOBALS['app_list_strings']['nlfal_alliances_members_1_f_list']=array (
  'unknown' => 'ei valintaa',
  'account1' => 'asiakas1',
  'account2' => 'asiakas2',
);
$GLOBALS['app_list_strings']['nlfal_alliances_services_list']=array (
  'unknown' => 'ei tiedossa',
  'finna' => 'Finna',
  'melinda' => 'Melinda',
  'finelib' => 'FinElib',
  'julkaisuarkisto' => 'Julkaisuarkistot',
);
...
$GLOBALS['app_list_strings']['finna_sopimus_list']=array (
  ...
  'finnasopimus2017_2018' => 'Palvelusopimus 2017-2018 (päättyy 31.12.2018)',
  'finnasopimusOKMulkop2016_2018' => 'OKM:n ulkop Palvelusopimus 2016-2018 (päättyy 31.12.2018)',
  'finnasopimus2013_2014' => 'Palvelusopimus 2013-2014 (päättynyt)',
  'finnasopimus2012_2013' => 'Palvelusopimus 2012-2013 (päättynyt 31.12.2013)',
);
$GLOBALS['app_list_strings']['finna_contact_role_list']=array (
  'yhteyshenkilo' => 'Yhteyshenkilö',
  'projektinvetaja' => 'Projektin vetäjä',
  'sopimusyhdyshenkilo' => 'Sopimusyhdyshenkilö',
  'tekninen' => 'Tekninen yhteyshenkilö',
  'finnanakyma' => 'Finna-näkymän yhteyshenkilö',
  'poissa_valiaikainen' => 'Poissa väliaikaisesti (virka-/hoitovapaa tms.)',
);

$GLOBALS['app_list_strings']['sopimukset_moduulista_list']=array (
  'ei_sopimusta' => 'Ei voimassaolevaa palvelusopimusta',
  'palvelukohtainen_sopimus1' => 'Palvelukohtainen sopimus 1',
);
$GLOBALS['app_list_strings']['asiakassuhde_list']=array (
...
$GLOBALS['app_list_strings']['contract_type_list']=array (
  ...
  'muu' => 'Onko muita tyyppejä?',
);

$GLOBALS['app_list_strings']['sopimusliitteet_list']=array (
  'finna_liite1' => 'Liite1 - Liite vapaasti käytettävissä olevasta metatiedosta (sovelletaan aina)',
  'finna_liite2' => 'Liite 2 - Palvelutasoliite (sovelletaan aina)',
  'finna_liite3' => 'Liite 3 - Liite linkityspalvelusta (sovelletaan sektorikohtaisesti)',
  'finna_liite4' => 'Liite 4 - Tietosuojaliite (sovelletaan aina)',
  'finna_liite5' => 'Liite 5 - Hinnoitteluliite (sovelletaan asiakaskohtaisesti)',
);

$GLOBALS['app_list_strings']['contract_status_list']=array (
  'voimassa_maaraaika' => 'Voimassa määräaikaisesti',
  'voimassa' => 'Voimassa toistaiseksi',
  'paattynyt' => 'Päättynyt',
);
$app_list_strings['moduleList']['Contacts']='Henkilöt';
$app_list_strings['moduleList']['nlfbr_BusinessRelationships']='Asiakassuhteet';
$app_list_strings['moduleList']['nlfal_Alliances']='Yhteenliittymät';
$app_list_strings['moduleList']['nlfro_Roles']='Roolit';
$app_list_strings['moduleList']['nlfwg_WorkingGroups']='Työryhmät';
$app_list_strings['moduleListSingular']['Contacts']='Henkilö';
$app_list_strings['moduleListSingular']['nlfbr_BusinessRelationships']='Asiakassuhde';
$app_list_strings['moduleListSingular']['nlfal_Alliances']='Yhteenliittymä';
$app_list_strings['moduleListSingular']['nlfro_Roles']='Rooli';
$app_list_strings['moduleListSingular']['nlfwg_WorkingGroups']='Työryhmä';
$app_list_strings['record_type_display']['Contacts']='Henkilö';
$app_list_strings['parent_type_display']['Contacts']='Henkilö';
$app_list_strings['record_type_display_notes']['Contacts']='Henkilö';
...
$app_list_strings['moduleList']['Accounts']='Organisaatiot';
$app_list_strings['moduleListSingular']['Accounts']='Organisaatio';
$app_list_strings['record_type_display']['Accounts']='Organisaatio';
$app_list_strings['parent_type_display']['Accounts']='Organisaatio';
$app_list_strings['record_type_display_notes']['Accounts']='Organisaatio';
...
$GLOBALS['app_list_strings']['contact_role_list']=array (
  ...
  'wg_varapuheenjohtaja' => 'Varapuheenjohtaja',
  'wg_jasen' => 'Jäsen',
...
$GLOBALS['app_list_strings']['lead_source_dom']=array (
  '' => '',
  'Other' => 'Muu',
  'Palveluposti' => 'Palveluposti',
  'Word of mouth' => 'Suullinen tiedustelu',
  'Email' => 'Sähköposti',
  'Cold Call' => 'Uusi soitto',
  'Existing Customer' => 'Vanha asiakas',
);
$app_list_strings['moduleList']['Leads']='Potentiaaliset asiakkuudet';
$app_list_strings['moduleListSingular']['Leads']='Potentiaalinen asiakkuus';
$app_list_strings['record_type_display']['Leads']='Potentiaalinen asiakkuus';
$app_list_strings['parent_type_display']['Leads']='Potentiaalinen asiakkuus';
$app_list_strings['record_type_display_notes']['Leads']='Potentiaalinen asiakkuus';
$app_list_strings['moduleList']['nlfbs_BackendSystems']='Tietojärjestelmät';
$app_list_strings['moduleListSingular']['nlfbs_BackendSystems']='Tietojärjestelmä';

$GLOBALS['app_list_strings']['jarjestelmantyyppi_list']=array (
  'unknown' => 'Ei tiedossa',
  'arkisto' => 'Arkistojärjestelmä',
  'museo' => 'Museon kokoelmanhallintajärjestelmä',
  'kirjasto' => 'Kirjastojärjestelmä',
...
$GLOBALS['app_list_strings']['workinggroup_status_c_list']=array (
  'unknown' => 'Ei tiedossa',
  'toiminnassa' => 'Toiminnassa',
  'lakkautettu' => 'Lakkautettu',
  'tauolla' => 'Tauolla',
);
$GLOBALS['app_list_strings']['workinggroup_tyyppi_list']=array (
  'unknown' => 'Ei tiedossa',
  'asiantuntija' => 'Asiantuntijaryhmä',
  'ohjausryhma' => 'Ohjausryhmä',
);

$GLOBALS['app_list_strings']['palvelu_liittymisen_status_list']=array (
  'unknown' => 'Ei tiedossa',
  'ilmoittautunut' => 'Ilmoittautunut/ Hyväksytty',
  'tyoanalla' => 'Työn alla',
  'tuotannossa' => 'Tuotannossa',
);
