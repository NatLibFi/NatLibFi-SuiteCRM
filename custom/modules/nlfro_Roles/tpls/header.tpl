{* Copy of include/EditView/header.tpl, only using custom sugar_button_subpanel_aware function for rendering of $form.buttons *}
...
{{if !empty($form) && !empty($form.buttons)}}
   {{foreach from=$form.buttons key=val item=button}}
      {{sugar_button_subpanel_aware module="$module" id="$button" form_id="$form_id" view="$view" appendTo="header_buttons" location="HEADER"}}
   {{/foreach}}
{{else}}
