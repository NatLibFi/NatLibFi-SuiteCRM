{* Copy of include/EditView/header.tpl, only using custom sugar_button_subpanel_add_relationship function for rendering relevant buttons *}
...
{{if !empty($form) && !empty($form.buttons)}}
   {{foreach from=$form.buttons key=val item=button}}
      {{if $button == "SUBPANELADDRELATIONSHIP" }}
          {{sugar_button_subpanel_add_relationship  module="$module" id="$button" form_id="$form_id" view="$view" appendTo="header_buttons" location="HEADER"}}
      {{else}}
