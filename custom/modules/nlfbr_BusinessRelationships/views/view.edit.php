...
class nlfbr_BusinessRelationshipsViewEdit extends ViewEdit {
...
if ($this->ev->view === 'QuickCreate') {
    //$this->ev->defs['templateMeta']['form']['headerTpl'] = 'custom/modules/nlfbr_BusinessRelationships/tpls/header.tpl';
