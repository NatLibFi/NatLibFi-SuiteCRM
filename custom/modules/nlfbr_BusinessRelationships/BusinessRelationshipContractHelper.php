...
class BusinessRelationshipContractHelper {
    ...
    public function getContractData($brId, $serviceId = null, $useDbDateFormat = false) {
        return array_merge(
            $this->getActiveContractData($brId, $serviceId,  $useDbDateFormat),
            $this->getExpiredContractData($brId, $serviceId,  $useDbDateFormat)
        );
    }

    private function getActiveContractData($brId, $serviceId = null, $useDbDateFormat = false) {
        if (!$brId) {
            return array();
        }
    ...
    private function getExpiredContractData($brId, $serviceId = null, $useDbDateFormat = false) {
        if (!$brId) {
            return array();
        }
    ...
    public function getContractList($serviceId = null) {
        return array_merge(
            ...
            $this->getNonActiveContracts($serviceId)
        );
    }
