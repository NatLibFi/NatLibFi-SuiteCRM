{* Copy of themes/SuiteP/tpls/_headerModuleList.tpl except for quickcreatetop navigation *}
        ...
        <div class="mobile-bar">
            <ul id="toolbar" class="toolbar">
                <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    ...
                    <ul class="dropdown-menu" role="menu">
                    {foreach from=$quickCreateTopMenu item=linkLabel key=module name=quickCreateList}
                        <li{if $smarty.foreach.quickCreateList.last} class="last"{/if}><a href="index.php?module={$module}&action=EditView&return_module={$module}&return_action=DetailView">{$linkLabel}</a></li>
                    {/foreach}
                    </ul>
                </li>
