...
class ProjectTest extends PHPUnit_Framework_TestCase {
    ...
    public function testcreate_export_query()
    {
    	...
    	//test with empty string params
    	$expected = "SELECT\n				project.*,\n                users.user_name as assigned_user_name ,project_cstm.jjwg_maps_geocode_status_c,project_cstm.jjwg_maps_address_c,project_cstm.jjwg_maps_lng_c,project_cstm.jjwg_maps_lat_c FROM project  LEFT JOIN project_cstm ON project.id = project_cstm.id_c  LEFT JOIN users\n                   	ON project.assigned_user_id=users.id where  project.deleted=0 ";
