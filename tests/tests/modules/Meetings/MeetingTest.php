...
class MeetingTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testcreate_export_query()
    {
        ...
        $expected = 'SELECT meetings.*, users.user_name as assigned_user_name  ,meetings_cstm.jjwg_maps_geocode_status_c,meetings_cstm.jjwg_maps_address_c,meetings_cstm.jjwg_maps_lng_c,meetings_cstm.jjwg_maps_lat_c FROM meetings   LEFT JOIN users ON meetings.assigned_user_id=users.id  LEFT JOIN meetings_cstm ON meetings.id = meetings_cstm.id_c  where meetings.deleted=0';
