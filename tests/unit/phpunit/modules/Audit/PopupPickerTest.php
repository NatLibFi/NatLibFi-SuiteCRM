...
class PopupPickerTest extends SuiteCRM\StateCheckerPHPUnitTestCaseAbstract
{
    public function testProcessPage()
    {
        ...
        $this->assertContains('Fields audited in this module: Do Not Call, Lawful Basis Date Reviewed, Title, Description, Email Address, First Name, Salutation, Last Name, Other Phone, Office Phone, Assigned User, Lawful Basis Source, Lawful Basis', $output);
