...
$mod_strings = array(
    ...
    'DESC_EDIT_CUSTOM_FIELDS' => 'Muokkaa käyttäjän määrittelemiä kenttiä tässä layoutissa',
    ...
    'ERR_DELETE_RECORD' => 'Voidaksesi tuhota tilin, anna sen numero.',
    'ERR_ENABLE_CURL' => 'Tarkista, että curl on aktivoitu.',
    'ERR_EXPAND_DATABASE_COMPLETED' => 'Virhe: restoreExpand.sql -tiedoston olemassa olo viittaa siihen, että olet jo suurentanut tietokannan sarakkeet',
    ...
    'ERR_EMPTY_REGEX_DESCRIPTION' => 'Anna määritelmä Regex Requirement:iä varten. Tämä ohje näytetään käyttäjälle, kun hän antaa uutta salasanaa.',
    'ERR_NO_COLUMNS_TO_EXPAND' => 'Virhe: Tietokanta ei sisällä varchar, char tai tekstisarakkeita joita voisi laajentaa.',
    'ERR_NOT_FOR_MSSQL' => 'Tätä toimintoa ei ole implementoitu tälle konfiguraatiolle.',
    'ERR_NOT_FOR_MYSQL' => 'Tätä toimintoa ei ole implementoitu tälle konfiguraatiolle.',
    'ERR_NOT_FOR_ORACLE' => 'Tätä toimintoa ei ole implementoitu tälle konfiguraatiolle.',
    'ERR_NOT_IMPLEMENTED' => 'Tätä toimintoa ei ole implementoitu tälle konfiguraatiolle.',
    'ERR_NUM_OFFLINE_CLIENTS_MET' => 'Sinulla on jo käytössä kaikki Offline-käyttäjälisenssit. Passivoi joku käyttäjä tai hanki lisää lisenssejä.',
    'ERR_OC_USER_ALREADY_EXISTS' => 'Valitsemasi käyttäjä on jo olemassa.',
    ...
    'ERR_UW_MUST_SELECT_OVERWRITE_OPTION' => 'Valitse yksi päällekirjoittamisen vaihtoehdoista',
    ...
    'ERR_UW_NO_UPLOAD_FILE' => "Valitse Selaa etsiäksesi tiedoston jonka haluat ladata.<br>\n",
    ...
    'ERR_UW_REMOVE_PACKAGE' => "Paketin poistamisessa sattui ongelma.",
    'ERR_UW_RUN_SQL' => "Sql -tiedostoa ei voitu suorittaa:",
    'ERR_UW_UPDATE_CONFIG' => "Versioinformaation päivitys config.php tiedostoon ei onnistunut.",
    'ERR_UW_UPLOAD_ERROR' => "Tiedoston lataus ei onnistunut. Yritä uudelleen!<br>\n",
    'ERROR_FLAVOR_INCOMPATIBLE' => 'Lataamasi tiedosto ei ole yhteensopiva tämän SuiteCRM:n version kanssa.',
    ...
    'LBL_ACCEPT' => 'Hyväksy',
    'LBL_ADMIN_SUGAR_SERVER' => 'Ylläpitäjän käyttäjänimi:',
    'LBL_ADMIN_WIZARD_TITLE' => 'Admin Wizard',
    'LBL_ADMIN_WIZARD' => 'Määrittele SuiteCRM -järjestelmäsi helposti',
    ...
    'LBL_ALREADY_RUNNING' => 'Palvelin toimii Offline -asiakkaana',
    'LBL_APPLY_DST_FIX_DESC' => 'Tämä pakollinen vaihe päivittää ajan käsittelyyn liittyvää toiminnallisuutta (VAIN MYSQL)',
    'LBL_APPLY_DST_FIX' => 'Käytä kesäajan tallennukseen liittyvää korjausta',
    'LBL_AVAILABLE_MODULES' => 'Ladattavissa olevat moduulit',
    ...
    'LBL_BACKUP' => 'Ajoita varmuuskopio SuiteCRM:n Online Data Vaultiin.
Aja järjestelmän palautus varmuuskopiolta.',
    ...
    'LBL_CHECK_FOR_UPDATES' => 'Tarkista päivitykset',
    'LBL_CHECK_NOW_LABEL' => 'Tarkista nyt',
    'LBL_CHECK_NOW_TITLE' => 'Tarkista nyt',
    'LBL_CHECK_DB_VARDEFS' => 'Tarkistetaan tietokannan rakenne, vardefs...',
    ...
    'LBL_CLEAR_CHART_DATA_CACHE_DESC' => 'Poistaa kaavioiden käyttämien tietojen välimuistikopiot',
    'LBL_CLEAR_CHART_DATA_CACHE_TITLE' => 'Tyhjennä kaaviodatan välimuisti',
    ...
    'LBL_CLEAR_THEME_CACHE_DESC' => 'Poistaa teemojen välimuistissa olevat tiedot',
    'LBL_CLEAR_THEME_CACHE_TITLE' => 'Tyhjennä Teemat välimuistista',
    ...
    'LBL_CLEAR_PDFFONTS_DESC_SUCCESS' => 'Onnistui: PDF fontti välimuisti poistettu',
    'LBL_CLEAR_PDFFONTS_DESC_FAILURE' => 'Error : Clearing PDF Font Cache File failed',
    'LBL_CLEAR_PDF_FONT_CACHE_TITLE' => 'Tyhjennä PDF fontit välimuistista',
    ...
    'LBL_CONFIG_FTS' => 'Muokkaa tekstihaun moottoria',
    ...
    'LBL_CONFIGURATOR_DESC' => 'Määrittele Config.php',
    'LBL_CONFIGURATOR_TITLE' => 'Asetusohjelma',
    ...
    'LBL_CONFIGURE_UPDATER' => 'Muokkaa SuiteCRM-päivityksiä',
    'LBL_CONTRACT_TITLE' => 'Sopimukset',
    'LBL_CONTRACT_DESC' => 'Määrittele Sopimukset-moduulin sopimustyypit. Kun käyttäjä luo sopimuksen, valittava sopimustyyppi voidaan valita pudotusvalikosta.',
    'LBL_CONTRACT_TYPES' => 'Hallinnoi sopimustyyppejä',
    ...
    'LBL_DIAGNOSTIC_SUGARLOG' => 'SuiteCRM lokitiedosto',
    ...
    'LBL_DST_SET_USER_TZ' => 'Määrittele käyttäjien aikavyöhykkeet',
    'LBL_DST_START_DATE_TIME' => 'Aloitus pvm/aika',
    ...
    'LBL_FTS_SETTINGS' => 'Tekstihaku',
    'LBL_FTS_SETTINGS_DESC' => 'Muokkaa tekstihakujärjestelmää.',
    'LBL_GLOBAL_TEAM_DESC' => 'Näkyvillä kaikkialla',
    ...
    'LBL_INBOUND_EMAIL_TITLE' => 'Saapuneet sähköpostit',
    ...
    'LBL_LICENSE_EXPIRE_DATE' => 'Vanhhentumispvm',
    ...
    'LBL_MANAGE_LAYOUT' => 'Kenttä asettelu',
    ...
    'LBL_MANAGE_TEAMS_TITLE' => 'Tiimien ylläpito',
    'LBL_MANAGE_TEAMS' => 'Hallinnoi tiimien jäseniä ja ominaisuuksia',
    ...
    'LBL_MANAGE_WORKFLOW' => 'Työnkulkujen hallinta',
    'LBL_MANUFACTURERS_TITLE' => 'Valmistajat',
    'LBL_MANUFACTURERS' => 'Määrittele valmistajien luettelo',
    ...
    'LBL_PRICE_LIST_TITLE' => 'Tuotteet ja tarjoukset',
    ...
    'LBL_PRODUCT_CATEGORIES_TITLE' => 'Tuoteryhmät',
    'LBL_PRODUCT_CATEGORIES' => 'Muokkaa tuoteryhmien luetteloa',
    'LBL_PRODUCT_TYPES_TITLE' => 'Tuotteiden tyypit',
    'LBL_PRODUCT_TYPES' => 'Määrittele tuotteiden tyypit',
    'LBL_PRODUCTS_TITLE' => 'Tuoteluettelo',
...
//END SUGARCRM flav=een
    ...
    'LBL_REPAIR_ORACLE_COMMIT' => 'Toteuta',
    ...
    'LBL_SUGAR_UPDATE_TITLE' => 'SuiteCRM-päivitykset',
    ...
    'LBL_TO' => ' - ',
    'LBL_TRACKER_SETTINGS' => 'Seuranta',
    'LBL_TRACKER_SETTINGS_DESC' => 'Select what system and user data is tracked',
    'LBL_SUGARFEED_SETTINGS' => 'Viimeaikaiset toiminnat',
    ...
    'LBL_UPGRADE_ALREADY_EXISTS_IN_GROUP' => 'On jo ryhmässä:',
    ...
    'LBL_UW_MODE_DISABLE' => 'Ei käytössä',
    ...
    'LBL_WORKFLOW_TITLE' => 'Työnkulkujen hallinta',
    ...
    'LNK_NEW_PORTAL_USER' => 'Luo uusi portaalikäyttäjä',
    'LNK_NEW_GROUP_USER' => 'Tee uusi käyttäjäryhmä',
    'MI_LBL_DISABLE_DEPEDENCIES' => 'Moduulia ei voi ottaa pois käytöstä koska jotkin muut moduulit vaativat tämän moduulin toimiakseen.',
    ...
    'ML_LBL_INSTALL_FROM_SERVER' => 'Asenna palvelimelta',
    ...
    'ML_SUGAR_KB' => 'SuiteCRM Tietokanta',
    ...
    'UserPreferences' => 'Käyttäjäasetukset',
    'Versions' => 'Versio',
    ...
    'LBL_SAML_LOGIN_URL' => 'Sisäänkirjautumissivun URL',
    ...
    'LBL_AVAILABLE_FTS_MODULES' => 'Valitse luetteloitavat moduulit.',
    ...
    'LBL_SAVE_SCHED_WARNING' => 'Oletko varma, että haluat suorittaa järjestelmän luetteloinnin nyt? Luetteloinnin suorittaminen voi vaikuttaa järjestelmän suorituskykyyn.',
    'LBL_FTS_NO_MODULES' => 'Valitse ainakin yksi moduuli, josta haetaan.',
    'LBL_FTS_NO_MODULES_FOR_SCHED' => 'Valitse ainakin yksi ajoitettava moduuli.',
    'LBL_FTS_ADVANCED_LINK' => 'Ota moduulit käyttöön',
    ...
    'LBL_JJWG_MAPS_ADMIN_DONATE_TITLE' => 'Lahjoita tälle projektille',
    ...
    'LBL_COLOUR_SETTINGS' => 'Teeman asetukset',
    'LBL_COLOUR_DESC' => 'Muokkaa SuiteCRM -teemaa brändisi mukaiseksi.',
    'LBL_COLOUR_ADMIN_INTRO' => 'Näiden asetusten avulla voit muokata SuiteCRM: n teemaa.<strong>Huom:</strong>Muista päivittää sivu (Ctrl + F5) kun olet muuttanut asetuksia.',
    'LBL_DISPLAY_SIDEBAR' => 'Näytä sivupalkki',
    'LBL_COLOUR_ADMIN_MENU' => 'Valikkovärin asetukset',
    'LBL_COLOUR_ADMIN_PAGE' => 'Sivun värin asetukset',
    ...
    'LBL_COLOUR_ADMIN_BUTTON' => 'Painikkeiden väriasetukset',
    ...
    'LBL_COLOUR_ADMIN_TABS' => 'Valikon sisällön asetukset',
    ...
    'LBL_SALESAGILITY_ADMIN' => 'OpenAdmin edistyneet asetukset',
    'LBL_AOP_ADMIN_MANAGE_AOP' => 'OpenPortal edistyneet asetukset',
    'LBL_AOP_ENABLE_AOP' => 'Ota AOP käyttöön',
    ...
    'LBL_AOP_CASE_REMINDER_EMAIL_TEMPLATE' => 'Palvelupyynnön muistutus viestimalli',
    ...
    'LBL_AOP_OPENING_DAYS' => 'Aukiolopäivät',
    'LBL_AOP_OPENING_HOURS' => 'Aukiolotunnit',
    'LBL_AOP_CLOSING_HOURS' => 'Sulkemisajat',
    ...
    'LBL_SINGLE_USER' => 'Yksittäinen käyttäjä',
    'LBL_AOP_SETTINGS' => 'AOP asetukset',
    ...
    'LBL_AOD_ADMIN_MANAGE_AOD' => 'OpenDiscoveryn edistyneet asetukset',
    'LBL_AOD_ENABLE' => 'Ota AOD käyttöön',
    'LBL_AOD_SETTINGS' => 'AOD:n asetukset',
    ...
    'LBL_AOS_ADMIN_MANAGE_AOS' => 'Edistyneet OpenSales asetukset',
    ...
    'LBL_AOS_SETTINGS' => 'AOS asetukset',
    'LBL_AOS_PRODUCTS' => 'AOS tuotteet',
    'LBL_AOS_EDIT' => 'Muokkaa',
    'LBL_AOS_DAYS' => 'päivää',
    'LBL_CHANGE_SETTINGS' => 'Muuta Advanced OpenSales asetuksia',
