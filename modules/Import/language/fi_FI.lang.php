...
$mod_strings = array (
    'LBL_GOOD_FILE' => 'Tuotava tiedosto luettu onnistuneesti',
    ...
    'LBL_NO_ID' => 'ID vaaditaan',
    'LBL_PRE_CHECK_SKIPPED' => 'Esitarkastus jätetty väliin',
    'LBL_IMPORT_ERROR' => 'Tuontivirheet:',
    'LBL_ERROR' => 'Virhe',
    'LBL_NOLOCALE_NEEDED' => 'Ei tarvita paikallista muunnosta',
    ...
    'LBL_SHOW_HIDDEN' => 'Näytä kentät, jotka eivät ole tuotavissa normaalisti',
    'LBL_UPDATE_RECORDS' => 'Päivitä olemassa olevat tietueet tuonnin sijaan (Ei voi peruuttaa)',
    'LBL_TEST'=> 'Testaa tuonti (ei tallenna tai muuta tietueita)',
    'LBL_TRUNCATE_TABLE' => 'Tyhjennä taulu(tietokannasta) ennen tuontia (Poista kaikki tietueet)',
    'LBL_RELATED_ACCOUNTS' => 'älä luo liittyviä asiakkaita',
    'LBL_NO_DATECHECK' => 'Ei päivämäärän tarkistusta (Nopeampi, mutta epäonnistuu jos joku pvm. on virheellinen)',
