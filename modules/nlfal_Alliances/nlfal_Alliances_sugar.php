 ...
 * PLACE ANY CUSTOMIZATIONS IN nlfal_Alliances
 */


class nlfal_Alliances_sugar extends Basic {
	var $new_schema = true;
	var $module_dir = 'nlfal_Alliances';
	var $object_name = 'nlfal_Alliances';
	var $table_name = 'nlfal_alliances';
	var $importable = true; // nvolk 2017-05-27 false;
    ...
    /**
     * Note: this is custom addition to the Alliance class. It is done that way,
     * as it is not possible to adjust all the code referring to Alliance class in
     * a update-safe way.
     * This custom method must be carried over whenever SuiteCRM is updated,
     * and the Allince bean class changes.
     */
	/**
